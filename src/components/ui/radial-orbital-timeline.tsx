...
export function RadialOrbitalTimeline({
    ...
    const calculateNodePosition = (index: number, total: number) => {
        ...
        const radius = 160; // Slightly smaller to fit in grid
    ...
    return (
        <div
            className="w-full aspect-square flex flex-col items-center justify-center overflow-visible relative"
            ref={containerRef}
        ...
        >
            <div className="relative w-full h-full flex items-center justify-center">
                ...
                >
                    {/* Core Visual */}
                    <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-indigo-500 via-blue-500 to-cyan-500 animate-pulse flex items-center justify-center z-10 shadow-[0_0_30px_rgba(79,70,229,0.3)]">
                    ...
                    {/* Orbit Line */}
                    <div className="absolute w-[320px] h-[320px] rounded-full border border-white/5"></div>
                ...
                `}
                                ...
                                {isExpanded && (
                                    <Card className="absolute top-16 left-1/2 -translate-x-1/2 w-64 bg-zinc-900/90 backdrop-blur-xl border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.5)] overflow-visible">
                                        ...
                                        <CardContent className="text-xs text-zinc-400">
                                            ...
                                            <div className="mt-4 pt-3 border-t border-white/5">
                                                <div className="flex justify-between items-center text-[10px] mb-1 uppercase tracking-wider">
                                            ...
                                            {item.relatedIds.length > 0 && (
                                                <div className="mt-4 pt-3 border-t border-white/5">
                                                    <div className="flex items-center mb-2">
                                                        ...
                                                        <h4 className="text-[10px] uppercase tracking-widest font-medium text-zinc-500">
                                                            Connected Steps
                                                        </h4>
                                                    </div>
                                                    <div className="flex flex-wrap gap-1">
                                                        {item.relatedIds.map((relatedId) => {
                                                            ...
                                                            return (
                                                                <button
                                                                    key={relatedId}
                                                                    className="flex items-center h-6 px-2 text-[9px] uppercase tracking-wider rounded-md border border-white/10 bg-white/5 hover:bg-white/10 text-zinc-400 hover:text-white transition-all"
                                                                    onClick={(e) => {
                                                                        e.stopPropagation();
