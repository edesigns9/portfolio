        ...
        >
            ...
            >
                {testimonials.map((t, i) => (
                    <motion.div
                        key={i}
                        className={`w-6 h-6 rounded-full border-2 border-background overflow-hidden transition-all duration-300 ${i === activeIndex ? "ring-1 ring-[var(--testimonial-accent)] ring-offset-1 ring-offset-background" : "grayscale opacity-50"
                            }`}
            ...
            <div className="relative">
                ...
                <motion.div className="mt-12 relative" layout>
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative w-12 h-12">
                            <motion.div
                                className="absolute -inset-1.5 rounded-full border border-[var(--testimonial-accent)]/40"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <motion.div
                                    className="absolute left-0 top-0 bottom-0 w-px bg-[var(--testimonial-accent)]"
                                    initial={{ scaleY: 0 }}
                                    animate={{ scaleY: 1 }}
                                ...
                                <span className="block text-xs text-muted-foreground mt-0.5 font-mono uppercase tracking-widest text-[10px]">
                ...
                <div className="mt-16 h-px bg-border relative overflow-hidden">
                    <motion.div
                        className="absolute inset-y-0 left-0 bg-[var(--testimonial-accent)]"
                        initial={{ width: "0%" }}
